...
\title{ZK Bootcamp: Day 10 Problem Set}
\author{Brian Justin Stout\footnote{email: bjstout@proton.me}}
\maketitle

\begin{prb}\label{P1}
Add Polygon ZkEVM testnet to your wallet
\end{prb}

Completed.

\begin{prb}\label{P2}
Bridge gETH test ether to Polygon ZkEVM
\end{prb}

Completed.

\begin{prb}\label{P3}
Create a simple contract in Remix, and deploy using metamask as the injected provider.
\end{prb}
    
Completed. I deployed a Zocrates verifier contract for a Groth16 ZKP created earlier in the course.

\begin{prb}\label{P4}
Check deployment and transaction.
\end{prb}

The verifier contract deployed successfully in txid 

$$\mathrm{0xa3bd1555cb1133eab5e051be3cf81d5c00362963256e4d1c5a0c0d9c265d8e69}$$

to contract address

$$\mathrm{0xBd8bc2F1C9f10065DD758163cDaD6A7f16F1f163}$$
\end{document}
