...
\title{ZK Bootcamp: Day 12 Problem Set}
\author{Brian Justin Stout\footnote{email: bjstout@proton.me}}
\maketitle

\begin{prb}\label{P1}
Use the partial circom code to complete the constraint on line 19 and add appropriate inputs. Generate a proof. Show that an incorrect proof fails.
\end{prb}
